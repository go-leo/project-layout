...
var file_pkg_nacosx_config_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x6e, 0x61, 0x63, 0x6f, 0x73, 0x78, 0x1a, 0x1e, 0x67, 0x6f,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x6e, 0x61, 0x63, 0x6f, 0x73, 0x78, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x6e, 0x61, 0x63, 0x6f, 0x73, 0x78, 0x2e, 0x4f,
...
var file_pkg_nacosx_config_proto_goTypes = []interface{}{
	(*Config)(nil),                 // 0: leo.config.nacosx.Config
	(*Options)(nil),                // 1: leo.config.nacosx.Options
	nil,                            // 2: leo.config.nacosx.Config.ConfigsEntry
	(*wrapperspb.StringValue)(nil), // 3: google.protobuf.StringValue
	(*wrapperspb.Int32Value)(nil),  // 4: google.protobuf.Int32Value
}
var file_pkg_nacosx_config_proto_depIdxs = []int32{
	2, // 0: leo.config.nacosx.Config.configs:type_name -> leo.config.nacosx.Config.ConfigsEntry
	3, // 1: leo.config.nacosx.Options.address:type_name -> google.protobuf.StringValue
	4, // 2: leo.config.nacosx.Options.port:type_name -> google.protobuf.Int32Value
	3, // 3: leo.config.nacosx.Options.namespace:type_name -> google.protobuf.StringValue
	1, // 4: leo.config.nacosx.Config.ConfigsEntry.value:type_name -> leo.config.nacosx.Options
